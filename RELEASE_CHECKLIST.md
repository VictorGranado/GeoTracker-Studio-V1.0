# GeoTracker Studio v1.0 — Release Checklist

- [ ] `python -m pytest -q` passes.
- [ ] Source build launches with `python -m geotracker_studio.app`.
- [ ] `Build_Windows.ps1` produces `dist\GeoTracker Studio v1.0\GeoTracker Studio.exe`.
...
- [ ] `Build_Installer.ps1` creates `GeoTracker Studio v1.0 Setup.exe` when Inno Setup 6 is available.
